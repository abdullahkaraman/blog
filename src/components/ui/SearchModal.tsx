		...
		<div className="max-w-full sm:max-w-[540px]">
			{variant === 'bar' ? (
				<Button
					...
					aria-label="Search"
					className="h-10 w-[180px] justify-start gap-2 rounded-full bg-neutral-100 px-4 text-sm font-normal text-neutral-600 hover:bg-neutral-200 hover:text-neutral-800 sm:w-[260px] [&_svg]:text-neutral-500"
				>
